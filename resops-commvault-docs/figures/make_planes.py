...
Colors mirror theme/assets/tokens.css; change them there first.
"""
import base64
from pathlib import Path

REPO = Path(__file__).resolve().parents[2]      # the workshop-docs root
HERE = Path(__file__).resolve().parents[1]      # this workshop's folder
ICONS = REPO / "theme/assets/icons"
...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 400"
  ...
  <!-- Colors mirror theme/assets/tokens.css: ink #00053b, line #eaeaea,
...
out = HERE / "images" / "three-planes.svg"
