...
outside its reach. Colors mirror theme/assets/tokens.css (the yes
...
its reach, so the gate holds.">
  <!-- Colors mirror theme/assets/tokens.css: the yes shade #30881c,
...
out = HERE / "images" / "proof-timeline.svg"
out.write_text(svg)
